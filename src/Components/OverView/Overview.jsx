...
export const OverView = () => {
    return(
        <div className=" p-[20px] bg-gray-800 m-[20px] my-[50px] rounded  flex justify-center text-center">
          
            <div className="px-[20px]  py-[70px] md:max-w-[500px] max-w-[400px] flex flex-col gap-[20px] ">
