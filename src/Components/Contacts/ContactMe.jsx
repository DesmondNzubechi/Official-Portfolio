...
export const ContactMe = () => {
    return(
        <div className="min-h-[100vh] rounded after:bg-Contact p-[30px] bg-fixed after:min-h-[100%] relative after:absolute after:top-0 after:left-0 after:right-0 after:w-full bg-cover bg-no-repeat bg-[url('Components/Contacts/nzube.png')] ">
