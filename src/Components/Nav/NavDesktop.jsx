...
export const NavDesktop = () => {
    return(
        <div className="flex flex-row items-center gap-[20px] md:px-[50px] px-[20px] fixed top-0 left-0 right-0 w-full  px-[20px] py-[20px] justify-between ">
            <div className="bg-slate-900  shadow-2xl rounded p-2 mx-[20px] ">
                <h1 className="font-bold uppercase  text-slate-50">Nzube <br /> Chukwu</h1>
            </div>
            <div className="bg-slate-900 p-2 shadow-xl ">
                <FaBars className="text-slate-50 md:mr-[50px]  text-[40px]  "/>
            </div>
