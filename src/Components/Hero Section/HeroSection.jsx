...
export const HeroSection = () => {
    ...
    return(
       ...
       <div data-aos='fade-up' data-aos-duration='1000' className="max-w-[500px] flex flex-col gap-2 ">
        ...
        <p className="text-slate-50 max-w-[400px] flex flex-col gap-2 text-[16px]  md:text-[20px] capitalize "><span className="font-bold"> Developing & Bringing ideas to live</span> <span>I build product that is user-friendly and accessible by the right user.</span></p>
