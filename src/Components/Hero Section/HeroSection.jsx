...
export const HeroSection = () => {
    ...
    return(
       ...
       <div data-aos='fade-up' data-aos-duration='1000' className="max-w-[500px] flex flex-col gap-2 ">
        <h1 className="uppercase font-myfont text-[25px] md:text-[40px] text-slate-50  ">Desmond Nzubechukwu</h1>
        <p className="text-slate-50 text-[16px] md:text-[20px] capitalize ">I am a passionate <strong>frontend web developer.</strong> <br /> I create beautiful, intuitive, and user-friendly websites that not only meet the needs of my clients but also exceed the expectations of their users. </p>
