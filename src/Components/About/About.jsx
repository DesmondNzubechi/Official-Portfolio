...
<div className="flex flex-col md:flex-row justify-around items-start gap-5">
  ...
  <div className="">
    ...
    <div className="text-slate-300 font-fonty flex flex-col gap-5 ">
    <p className="md:text-[17px] text-[15px] ">Hi, my name is <strong className="uppercase text-slate-50">Desmond Nzubechukwu Abugu</strong> , and I am a frontend web developer with expertise in HTML, CSS, JavaScript, ReactJS, and TailwindCSS. With a year of experience in the industry, I have had the opportunity to work on a wide range of projects, from simple websites to complex web applications.</p>
